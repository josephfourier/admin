package com.thinkjoy.oauth.client.interceptor;

import com.thinkjoy.common.util.RequestUtil;
...
/**
 * 日志记录AOP实现
 * Created by jingqinghua on 2017/3/14.
 */
@Aspect
public class LogAspect {
	...
	public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
		...
		if(!StringUtils.isEmpty(upmsLog.getUsername())){
			//获取当前登录的管理员用户
			UcenterUser ucenterUser =ucenterUserService.selectuserbeanMap(upmsLog.getUsername());
			upmsLog.setSchoolCode(ucenterUser.getSchoolCode());
		}
