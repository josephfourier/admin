...
<head>
    ...
    <link href="${basePath}/resources/thinkjoy-admin/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/thinkjoy-admin/plugins/checkbix/css/checkbix.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/thinkjoy-admin/css/login.css" rel="stylesheet"/>
    <script>
        var _hmt = _hmt || [];
        (function() {
...
<script src="${basePath}/resources/thinkjoy-admin/plugins/checkbix/js/checkbix.min.js"></script>
<script>var BASE_PATH = '${basePath}';</script>
<script>var BACK_URL = '${param.backurl}';</script>
<script src="${basePath}/resources/thinkjoy-admin/js/login.js"></script>
<script>
