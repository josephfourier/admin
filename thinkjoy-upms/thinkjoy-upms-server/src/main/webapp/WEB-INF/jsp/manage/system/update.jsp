...
<div id="updateDialog" class="crudDialog">
	<form id="updateForm" method="post">
		...
		<div class="form-group">
			...
			<input id="icon" type="text" class="form-control" name="icon" maxlength="40" value="${system.icon}">
		</div>
		<div class="form-group">
			<label for="title">标题</label>
			<input id="title" type="text" class="form-control" name="title" maxlength="60" value="${system.title}" required="true">
		</div>
		<div class="form-group">
			<label for="name">名称</label>
			<input id="name" type="text" class="form-control" name="name" maxlength="60" value="${system.name}" required="true">
		</div>

		<div class="bg">
			<div class="form-group">
				<label>背景图</label>
				<img src="${system.banner}" alt="背景图" class="path show">
				<input type="text" class="form-control" name="banner" readonly value="${system.banner}">
				<input type="text" class="tmp form-control show" readonly>
			</div>
