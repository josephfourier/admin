...
<head>
	...
	<title id="system_title">统一权限管理系统</title>
	...
	<link href="${basePath}/resources/thinkjoy-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
...
<header id="header">
	<ul id="menu">
		...
		<li id="logo" class="hidden-xs">
			...
			<span id="system_title">统一权限管理系统</span>
		</li>
		<li class="pull-right">
			<ul class="hi-menu">
				<!-- 搜索 -->
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu dm-icon pull-right">
						...
						<c:forEach var="upmsSystem" items="${upmsSystems}">
							<c:forEach var="upmsSystemsPermission" items="${upmsSystemsPermission}">
								<c:if test="${upmsSystem.systemId == upmsSystemsPermission.systemId}">
									<li>
...
<section id="main">
	...
	<aside id="sidebar">
		...
		<div class="s-profile">
			<a class="waves-effect waves-light" href="javascript:;">
				<div class="sp-pic">
					...
					<c:if test="${ empty upmsUser.avatar}">
						<img src="${basePath}/resources/thinkjoy-admin/images/avatar.jpg"/>
					</c:if>
					<c:if test="${ not empty upmsUser.avatar}">
		...
		<ul class="main-menu">
			...
			<li>
				<div class="upms-version">&copy; thinkjoy-UPMS V1.0.0</div>
			</li>
		</ul>
		<!-- /菜单区 -->
	</aside>
...
<script>var BACK_URL_TITLE = '${backUrl_title}';</script>
<script>var MANAGER_TYPE='${managerType}'</script>
