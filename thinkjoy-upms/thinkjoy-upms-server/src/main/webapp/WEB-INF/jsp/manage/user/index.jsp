...
<div id="main">
		...
		<%--<div class="form-inline search-form">--%>
			<%--<div class="search-group col-md-2">--%>
...
$(function() {
	...
	$table.bootstrapTable({
		...
		columns: [
			...
			{field: 'relationName', title: '学校/机构名称'},
            {field: 'managerType', title: '管理员类型', formatter: 'typeFormatter'},
...
function seach_filter(){
	$table.bootstrapTable('refresh',{url:'${basePath}/manage/user/list'});
}
// 格式化操作按钮
...
function schoolAction() {
    ...
    if (rows.length != 1) {
        ...
        schoolUserId = rows[0].userId;
        schoolDialog = $.dialog({
            animationSpeed: 300,
            title: '用户学校',
            content: 'url:${basePath}/manage/user/school/' + schoolUserId,
            onContentReady: function () {
                initMaterialInput();
                $('select').select2({
                    placeholder: '请选择用户学校',
