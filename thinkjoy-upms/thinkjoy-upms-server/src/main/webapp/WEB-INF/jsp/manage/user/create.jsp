       ...
       <%-- <div class="row">
        ...
        <div class="radio">
            <div class="radio radio-inline radio-info">
                <input id="managerType_1" type="radio" name="managerType" value="1">
                <label for="managerType_1">超级管理员</label>
            </div>
            <div class="radio radio-inline radio-danger">
                <input id="managerType_2" type="radio" name="managerType" value="2">
                <label for="managerType_2">区域管理员</label>
            </div>
            <div class="radio radio-inline radio-success">
                <input id="managerType_3" type="radio" name="managerType" value="3" checked>
        ...
        <div class="form-group" id="orgZtree">
            <div class="form-group">
                    ...
                    <input type="text" id="relationName" name="relationName" class="form-control" readonly="readonly" placeholder="学校/机构选择">
...
<script>
    ...
    var setting = {
        ...
        async: {
            enable: true,
            url: '${basePath}/manage/user/agencytree/-1'
        },
        data: {
            simpleData: {
                enable: true
