...
$(function() {
	...
	$table.bootstrapTable({
		...
		columns: [
			...
			{field: 'username', title: '用户名', align: 'center', formatter: 'usernameFormatter'},
			{field: 'startTimestamp', title: '创建时间', sortable: true, align: 'center', formatter: 'timeFormatter'},
			{field: 'lastAccessTime', title: '最后访问时间', formatter: 'timeFormatter'},
