package com.thinkjoy.upms.server.interceptor;
...
public class UpmsInterceptor extends HandlerInterceptorAdapter {
    ...
    private static final String THINKJOY_OSS_ALIYUN_OSS_POLICY = PropertiesUtil.getInstance().getProperties().getProperty("thinkjoy.oss.aliyun.oss.policy");
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        request.setAttribute("THINKJOY_OSS_ALIYUN_OSS_POLICY", THINKJOY_OSS_ALIYUN_OSS_POLICY);
        // 过滤ajax
