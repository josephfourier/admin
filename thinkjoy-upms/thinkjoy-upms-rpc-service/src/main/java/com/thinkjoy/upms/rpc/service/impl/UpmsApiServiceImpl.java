...
import com.thinkjoy.upms.dao.mapper.*;
import com.thinkjoy.upms.dao.model.*;
import com.thinkjoy.upms.rpc.api.UpmsApiService;
import com.thinkjoy.upms.rpc.mapper.UpmsApiMapper;
...
public class UpmsApiServiceImpl implements UpmsApiService {
     ...
     */
    @Override
    @Cacheable(value = "thinkjoy-upms-rpc-service-ehcache", key = "'selectUpmsPermissionByUpmsUserId_' + #upmsUserId")
     ...
     */
    @Override
    @Cacheable(value = "thinkjoy-upms-rpc-service-ehcache", key = "'selectUpmsRoleByUpmsUserId_' + #upmsUserId")
