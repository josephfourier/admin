...
public class Generator {
    ...
    // 基础属性,根据不同的项目修改
    private static final String MODULE = "thinkjoy-ams";
    private static final String DATABASE = "zjy";
    private static final String TABLE_PREFIX = "ams_approle";
    private static final String PACKAGE_NAME = "com.thinkjoy.ams";
