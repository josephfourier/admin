		...
		<div class="row">
			...
			<div class="checkbox">
				<div class="checkbox checkbox-inline checkbox-success">
					<input id="usertype_1" type="checkbox" name="userType" value="1">
					<label for="usertype_1">学生 </label>
				</div>
				<div class="checkbox checkbox-inline checkbox-success">
					<input id="usertype_2" type="checkbox" name="userType" value="2">
					<label for="usertype_2">家长 </label>
				</div>
				<div class="checkbox checkbox-inline checkbox-success">
					<input id="usertype_3" type="checkbox" name="userType" value="3">
					<label for="usertype_3">老师 </label>
				</div>
				<div class="checkbox checkbox-inline checkbox-success">
					<input id="usertype_4" type="checkbox" name="userType" value="4">
			...
			<div class="col-sm-12"  id="schoolTag" style="display:none">
				<div class="form-group">
					<div class="fg-line">
						<input type="text" id="schoolName" name="schoolName" class="form-control" value=""  onclick="initTreeTwo()";  placeholder="学校选择">
			...
			<div class="col-sm-12" id="orgTag" style="display:none">
				<div class="form-group">
					<div class="fg-line" >
						<input type="text" id="orgName" name="orgName" class="form-control" value=""  onclick="initTree()";  placeholder="组织选择">
			...
			<div class="col-sm-12">
				<div class="form-group">
					<div class="fg-line">
						...
						<input id="username" type="text" class="form-control" name="username" maxlength="300">
					</div>
				</div>
			</div>
			<div class="col-sm-12">
				<div class="form-group">
					<div class="fg-line">
						...
						<input id="fullname" type="text" class="form-control" name="fullname" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-sm-12">
			...
			<div class="col-sm-12">
				<div class="form-group">
					<div class="fg-line">
						...
						<input id="idcard" type="text" class="form-control" name="idcard" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-sm-12">
			...
			<%--<div class="col-sm-12">--%>
				<%--<div class="form-group">--%>
					<%--<div class="fg-line">--%>
						...
						<%--<input id="sex" type="text" class="form-control" name="sex" maxlength="20">--%>
					<%--</div>--%>
				<%--</div>--%>
			<%--</div>--%>
			<div class="col-sm-12">
			...
			<div class="col-sm-12" id="studentCode1" style="display:none">
				<div class="form-group">
					<div class="fg-line">
						...
						<input id="studentCode" type="text" class="form-control" name="studentCode" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-sm-12"  id="examineeNumber2" style="display:none">
				<div class="form-group">
					<div class="fg-line">
						...
						<input id="examineeNumber" type="text" class="form-control" name="examineeNumber" maxlength="20">
					</div>
				</div>
			</div>
			<div class="col-sm-12">
...
<script>
    ...
    function createSubmit() {
        $.ajax({
			...
			beforeSend: function() {
				if(checkboxs("userType")== false){
					$('#userType').focus().tips({msg: '请选择身份类型！'});
					return false;
				}
