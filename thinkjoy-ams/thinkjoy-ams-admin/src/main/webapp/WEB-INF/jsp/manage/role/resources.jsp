...
<div id="agencyDialog" class="crudDialog">
    <form id="agencyForm" method="post">
        ...
        <div class="form-group text-right dialog-buttons">
            ...
            <a class="waves-effect waves-button" href="javascript:;" onclick="resourcesDialog.close();">取消</a>
        </div>
    </form>
</div>
<script>
    ...
    var setting = {
        ...
        async: {
            enable: true,
            url: '${basePath}/manage/role/resourcetree/' + roleId
        },
        data: {
            simpleData: {
                enable: true
        ...
        callback: {
            onCheck: function() {
                ...
                for (var i = 0; i < changeNodes.length; i ++) {
                    var changeData = {};
                    changeData.resourceId = changeNodes[i].resourceId;
    ...
    function permissionSubmit() {
        $.ajax({
            type: 'post',
            url: '${basePath}/manage/role/resoures/' + roleId,
