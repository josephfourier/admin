...
<style>
    ...
    .sl2{
        text-align: right;}
    .lap-searchbar .tip{top:-1px;}
</style>

<div class="lap-page">
    <form id="updateForm" method="post">
        <div class="lap-searchbar" id="one">
            <label class="input">
                <span class="star"><i class="tip">*</i></span><span>招生年度</span>
                <input id="batchYear" type="text" class="form-control" name="batchYear"
        ...
        <div id="base-info">
            <div class="lap-section" id="first">
                    ...
                    <div class="form-inline">
                        <div class="form-group">
                            ...
                            <input id="studentName" type="text" class="form-control base-input" name="studentName"
                                   value="${enrollStudent.studentName}" readonly="readonly">
                        ...
                        <div class="form-group">
                            ...
                            <input id="idcard" type="text" class="form-control" name="idcard"
                                   value="${enrollStudent.idcard}" readonly="readonly">
                        </div>
                        ...
                        <div class="form-group">
                            <div class="sl2-group">
                                <label class="sl2">
                                    ...
                                    <select id="ppareaCode1" name="ppareaCode1" readonly="readonly">
                                        <option value="0">请选择省</option>
                                        <c:forEach var="ucenterAreas" items="${ucenterAreas}">
                                            <option value="${ucenterAreas.areaCode}"
                                ...
                                <label class="sl2">
                                    <select id="pareaCode1" name="pareaCode1" readonly="readonly">
                                        <option value="0">城市</option>
                                    </select>
                        ...
                        <div class="form-group lg">
                            ...
                            <input id="address" type="text" class="form-control base-input" name="address"
                                   value="${enrollStudent.address}" readonly="readonly">
                        </div>
                        <div class="form-group">
                            <label for="postalCode">邮政编码</label>
                            <input id="postalCode" type="text" class="form-control base-input" name="postalCode"
                                   value="${enrollStudent.postalCode}" readonly="readonly">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="gradSchool" type="text" class="form-control base-input" name="gradSchool"
                                   value="${enrollStudent.gradSchool}" readonly="readonly">
                        </div>
                        <div class="form-group">
                            <label class="sl2">
                        ...
                        <div class="form-group">
                            ...
                            <input id="gradTime" type="text" class="form-control base-input" name="gradTime"
                                   value="<fmt:formatDate value="${enrollStudent.gradTime}" type="both" pattern="yyyy-MM-dd"/>" readonly="readonly">
                        </div>
                        ...
                        <div class="form-inline">
                            ...
                            <div class="form-group">
                                ...
                                <input id="secondTrdrname" type="text" class="form-control base-info" name="secondTrdrname"
                                       value="${enrollStudent.secondTrdrname}" disabled="disabled"></div>
                            <div class="form-group">
                                ...
                                <input id="secondSchsys" type="text" class="form-control base-info" name="secondSchsys"
                                       value="${enrollStudent.secondSchsys}" disabled="disabled">
                    ...
                    <div class="form-inline">
                        <div class="form-group">
                            ...
                            <input id="score" type="text" class="form-control base-info" name="score"
                                   value="${enrollStudent.score}" readonly="readonly">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    if (readonly == 1) {
        ...
        $('#first select').prop('disabled', true);
        $('#one select').prop('disabled', true);
    ...
    function updateSubmit() {
        ...
        $.ajax({
            type: 'post',
            url: '${basePath}/manage/recruit/update/${enrollStudent.studentId}',
