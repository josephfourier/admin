...
layui.define("layer", function (e) {
    ...
    p.prototype.config = {
        ...
        var e = this, i = e.config, n = e.elemFile = t(['<input class="' + u + '" type="file" name="' + i.field + '"', i.multiple ? " multiple" : "", ">"].join("")), o = i.elem.next();
...
layui.define("jquery", function (e) {
    ...
    var t = layui.$, o = {
        fixbar: function (e) {
            ...
            var c = [e.bar1, e.bar2, "&#xe604;"], u = t(['<ul class="' + a + '">', e.bar1 ? '<li class="layui-icon" lay-type="bar1" style="' + e.bgcolor + '">' + c[0] + "</li>" : "", e.bar2 ? '<li class="layui-icon" lay-type="bar2" style="' + e.bgcolor + '">' + c[1] + "</li>" : "", '<li class="layui-icon ' + l + '" lay-type="top" style="' + e.bgcolor + '">' + c[2] + "</li>", "</ul>"].join("")), s = u.find("." + l), b = function () {
                var t = n.scrollTop();
            ...
            var i = this, a = "function" == typeof t, l = new Date(e).getTime(), n = new Date(!t || a ? (new Date).getTime() : t).getTime(), r = l - n, c = [Math.floor(r / 864e5), Math.floor(r / 36e5) % 24, Math.floor(r / 6e4) % 60, Math.floor(r / 1e3) % 60];
            a && (o = t);
