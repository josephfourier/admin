window.LCalendar = (function() {
    ...
    MobileCalendar.prototype = {
        init: function(params) {
            ...
            this.hidden = document.querySelector(params.hidden);
        ...
        bindEvent: function(type) {
            ...
            function dateCtrlInit() {
                ...
                _self.date_selected = document.querySelector(".date_selected");
                _self.date_selected.innerHTML= dateArr.yy + _self.minY + '年' + (1+dateArr.mm) + '月' + (1+dateArr.dd) + '日';
                setDateGearTooth();
            }
            //呼出年月插件
            function popupYM(e) {
            ...
            function setDateGearTooth() {
                ...
                var tooths_yy = document.getElementsByClassName('date_yy')[0].getElementsByClassName('tooth');
                var tooths_mm = document.getElementsByClassName('date_mm')[0].getElementsByClassName('tooth');
                var tooths_dd = document.getElementsByClassName('date_dd')[0].getElementsByClassName('tooth');
                var yy = _self.gearDate.querySelector(".date_yy").getAttribute("val");
                var mm = _self.gearDate.querySelector(".date_mm").getAttribute("val");
                var dd = _self.gearDate.querySelector(".date_dd").getAttribute("val");

                tooths_yy[yy].setAttribute('class', 'tooth year-selected')
                tooths_mm[mm].setAttribute('class', 'tooth year-selected')
                tooths_dd[dd].setAttribute('class', 'tooth year-selected')
                _self.date_selected.innerHTML= (~~yy + _self.minY) + '年' + (~~mm+1) + '月' + ((~~dd+1) < 10 ? '0' + ~~dd+1 : ~~dd+1)  + '日';
            ...
            function finishMobileDate(e) {
                ...
                _self.hidden.value = (date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd;
